...
class TrackingMatcher(nn.Module):
    """
    This class computes an assignment between the gt and predictions of the network.
    The corresponding feature vectors within the gt box are matched as postive samples.
    """
    def __init__(self):
        super().__init__()
